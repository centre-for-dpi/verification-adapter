// crypto-shim.js — Minimal polyfill for Node.js crypto.createHash("sha256")
// used by rdf-canonize inside the WASM sandbox where Node.js built-ins
// are unavailable.
//
// This implements only what rdf-canonize needs:
//   const h = crypto.createHash("sha256");
//   h.update(data);          // data is string or Buffer
...
// createHash shim matching Node.js crypto API subset.
